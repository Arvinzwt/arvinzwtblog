import {BlogDefinitions} from '@/lib/definitions'

export async function fetchBlogAdd(tag: BlogDefinitions) {
  // {
  //   id: string;
  //   color: string;
  //   label: string;
...
export async function fetchBlogDelete(blogId: string) {
  return true;
}

export async function fetchBlogEdit(blog: BlogDefinitions) {
  return 'ef508d22-e391-4399-9479-187aa697fc21';
}

export async function fetchBlogDetail(blogId: string) {
  return {
